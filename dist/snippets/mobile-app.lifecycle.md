<!-- ui-design-ecosystem:mobile-app:lifecycle:begin -->
## UI design system - temporary install

The `mobile-app` UI design system in this project is installed **for the
...
<!-- ui-design-ecosystem:mobile-app:lifecycle:end -->
