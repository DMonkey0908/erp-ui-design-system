<!-- ui-design-ecosystem:mobile-app:begin -->
## UI work

This project uses the `mobile-app` UI design system (Mobile app).

**Before creating or changing any interface** - a page, a screen, a component,
a chart, or how any of them look - load the `mobile-app-design` skill and
follow it. If the skill is not installed, fetch https://raw.githubusercontent.com/DMonkey0908/ui-design-ecosystem/main/dist/gpt/mobile-app.AGENTS.md.
...
<!-- ui-design-ecosystem:mobile-app:end -->
